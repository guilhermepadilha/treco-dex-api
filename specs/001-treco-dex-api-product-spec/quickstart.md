# Quickstart: Treco-Dex-API Backend Platform
...
3. Configure environment variables:
   - `DATABASE_URL=jdbc:postgresql://localhost:5432/treco-dex-api`
   - `DATABASE_USERNAME=treco-dex-api`
   - `DATABASE_PASSWORD=treco-dex-api`
