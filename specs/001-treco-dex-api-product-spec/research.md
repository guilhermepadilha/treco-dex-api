# Research: Treco-Dex-API Backend Platform
...
- Decision: Model object identity as species/type-level catalog entries.
  - Rationale: Aligns with the Treco-Dex-API Pokédex metaphor and simplifies the MVP by avoiding per-unit tracking of indistinguishable duplicates.
